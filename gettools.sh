...
# Clone AnyKernel3
git clone https://github.com/MArshadR/AnyKernel3-1 -b quantum-CAF AnyKernel3

#Download Clang
if [ ! -d clang ]; then
    wget https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+/refs/heads/master/clang-r383902.tar.gz
